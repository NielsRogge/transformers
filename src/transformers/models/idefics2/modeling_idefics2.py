...
class Idefics2Connector(nn.Module):
    ...
    def forward(self, image_hidden_states, attention_mask):
        ...
        print("Shape of image_hidden_states after modality projection:", image_hidden_states.shape)
        image_hidden_states = self.perceiver_resampler(context=image_hidden_states, attention_mask=attention_mask)
        print("Shape of image_hidden_states after perceiver resampling:", image_hidden_states.shape)
...
class Idefics2Model(Idefics2PreTrainedModel):
    ...
    def forward(
        ...
        if pixel_values is not None and image_hidden_states is not None:
            ...
            print("Shape of image_hidden_states after vision encoder:", image_hidden_states.shape)
        ...
        if past_seen_tokens == 0 and inputs_embeds is not None and image_hidden_states is not None:
            ...
            print("Shape of text embeddings before concatenation:", inputs_embeds.shape)
            inputs_embeds = self.inputs_merger(
                input_ids=input_ids,
                inputs_embeds=inputs_embeds,
                image_hidden_states=image_hidden_states,
            )
            print("Shape of final multimodal embeddings after concatenation:", inputs_embeds.shape)
        ...
        print("Shape of final hidden states after LLM:", outputs.last_hidden_state.shape)
