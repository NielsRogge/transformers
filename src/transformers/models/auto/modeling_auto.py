...
from ..perceiver.modeling_perceiver import (
...
MODEL_MAPPING = OrderedDict(
    [
        # Base model mapping
        (PerceiverConfig, PerceiverModel),
...
(PerceiverConfig, PerceiverForMaskedLM),
...
MODEL_FOR_CAUSAL_LM_MAPPING = OrderedDict(
    [
        ...
        (PerceiverConfig, PerceiverForCausalLM),
...
MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING = OrderedDict(
    [
        ...
        (PerceiverConfig, PerceiverForSequenceClassification),
...
MODEL_FOR_QUESTION_ANSWERING_MAPPING = OrderedDict(
    [
        ...
        (PerceiverConfig, PerceiverForQuestionAnswering),
...
(PerceiverConfig, PerceiverForTokenClassification),
...
(PerceiverConfig, PerceiverForMultipleChoice),
