...
class DeformableDetrEncoder(DeformableDetrPreTrainedModel):
    ...
    The encoder updates the flattened feature map through multiple deformable attention layers.
...
class DeformableDetrDecoder(DeformableDetrPreTrainedModel):
    ...
    def forward(
        ...
        Args:
            ...
            spatial_shapes (`torch.FloatTensor` of shape `(num_feature_levels, 2)`): Spatial shapes of the feature maps.
...
class DeformableDetrModel(DeformableDetrPreTrainedModel):
    ...
    def gen_encoder_output_proposals(self, memory, memory_padding_mask, spatial_shapes):
        ...
        Returns:
            `tuple(torch.FloatTensor)`: A tuple of feature map and bbox prediction.
                ...
                - output_proposals (Tensor[batch_size, num_reference_points, 4]): Normalized proposals, after an inverse sigmoid.
        """
    ...
    def forward(
        ...
        )  # TODO: probably need to check for torchscript
