...
class MaskRCNNConfig(PretrainedConfig):
    ...
    Args:
        ...
        rpn_loss_cls (`Dict`, *optional*, defaults to `{'type':
            'CrossEntropyLoss', 'use_sigmoid': True, 'loss_weight': 1.0}`): Configuration of the classification loss of
        ...
        mask_head_conv_out_channels (`int`, *optional*, defaults to 256):
            Number of output channels (feature dimension) of the convolutional layers of the mask head. "RoIAlign",
            "output_size": 14, "sampling_ratio": 0}`): Configuration of the RoI layer used by the mask head.
        mask_roi_extractor_roi_layer (`<fill_type>`, *optional*, defaults to `{'type':
            'RoIAlign', 'output_size': 14, 'sampling_ratio': 0}`): <fill_docstring>
