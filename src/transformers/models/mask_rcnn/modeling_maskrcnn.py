...
class MaskRCNNRPN(nn.Module):
    ...
    def __init__(self, config, num_classes: int = 1, reg_decoded_bbox: bool = False):
        ...
        self.loss_cls = WeightedCrossEntropyLoss(use_sigmoid=self.use_sigmoid_cls)
...
class MaskRCNNShared2FCBBoxHead(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.loss_cls = WeightedCrossEntropyLoss(loss_weight=1.0, use_sigmoid=False)
...
class MaskRCNNFCNMaskHead(nn.Module):
    ...
    def __init__(self, config, conv_kernel_size=3, scale_factor=2):
        ...
        self.loss_mask = WeightedCrossEntropyLoss(use_mask=True, loss_weight=1.0)
