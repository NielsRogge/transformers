...
from .image_processing_deimv2 import Deimv2ImageProcessorKwargs
...
class Deimv2ImageProcessorFast(BaseImageProcessorFast):
    ...
    def __init__(self, **kwargs: Unpack[Deimv2ImageProcessorKwargs]) -> None:
...
__all__ = ["Deimv2ImageProcessorFast"]
