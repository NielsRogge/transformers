...
from ...utils import filter_out_non_signature_kwargs, logging, requires_backends
...
class Deimv2ImageProcessorKwargs(ImagesKwargs, total=False):
    r"""
    format (`str`, *optional*, defaults to `AnnotationFormat.COCO_DETECTION`):
        Data format of the annotations. One of "coco_detection" or "coco_panoptic".
    do_convert_annotations (`bool`, *optional*, defaults to `True`):
        Controls whether to convert the annotations to the format expected by the DEIMV2 model. Converts the
...
def prepare_coco_detection_annotation(
    ...
    """
    Convert the target in COCO format into the format expected by Deimv2.
    """
...
class Deimv2ImageProcessor(BaseImageProcessor):
    ...
    valid_kwargs = Deimv2ImageProcessorKwargs
    ...
    def prepare_annotation(
        ...
        """
        Prepare an annotation for feeding into Deimv2 model.
        """
