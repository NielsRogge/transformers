...
from ..hgnet_v2 import HGNetV2Config
...
class Deimv2Config(PretrainedConfig):
    ...
    DEIMv2 detector according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a configuration close to the HGNetV2-based DEIMv2 variants described in the paper.
    ...
    Args:
        ...
        backbone_config (`Dict`, *optional*, defaults to `HGNetV2Config()`):
        ...
        **kwargs,
        ...
        if backbone_config is None and backbone is None:
            logger.info(
                ...
                "used by DEIMv2 for lightweight variants."
            )
    ...
    def from_backbone_configs(cls, backbone_config: PretrainedConfig, **kwargs):
        """Instantiate a [`Deimv2Config`] (or a derived class) from a pre-trained backbone model configuration and DETR model
        configuration.
