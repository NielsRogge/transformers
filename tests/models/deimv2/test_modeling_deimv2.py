...
from transformers import Deimv2Config, Deimv2ImageProcessor, HGNetV2Config, is_torch_available, is_vision_available
...
class Deimv2ModelTester:
    ...
    def get_config(self):
        ...
        return Deimv2Config.from_backbone_configs(
    ...
    def test_attention_outputs(self):
        ...
        for model_class in self.all_model_classes:
            ...
            if hasattr(self.model_tester, "num_hidden_states_types"):
                ...
                # Deimv2 should maintin encoder_hidden_states output
...
class Deimv2ModelIntegrationTest(unittest.TestCase):
    ...
    def default_image_processor(self):
        return Deimv2ImageProcessor.from_pretrained(CHECKPOINT) if is_vision_available() else None
