...
if is_vision_available():
    ...
    from transformers import Deimv2ImageProcessor, Deimv2ImageProcessorFast

if is_torch_available():
    import torch


class Deimv2ImageProcessingTester:
    def __init__(
        self,
        parent,
        batch_size=4,
...
class RtDetrImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    ...
    def setUp(self):
        super().setUp()
        self.image_processor_tester = Deimv2ImageProcessingTester(self)
