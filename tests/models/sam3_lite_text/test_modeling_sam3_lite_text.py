...
class Sam3LiteTextVisionModelTester:
    def __init__(
        self,
        parent,
        hidden_size=32,
    ...
    def get_config(self):
        ...
        return Sam3LiteTextVisionConfig(
    ...
    def create_and_check_model(self, config, pixel_values):
        model = Sam3LiteTextVisionModel(config=config)
...
@require_torch
class Sam3LiteTextVisionModelTest(ModelTesterMixin, unittest.TestCase):
    """
    Tests for SAM3 Vision Model (ViT backbone + FPN neck).
    """

    all_model_classes = (Sam3LiteTextVisionModel,) if is_torch_available() else ()
